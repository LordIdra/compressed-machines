...
public class CompressedElectricIngotFactory extends ElectricIngotFactory {
	
	private int compression = 1;

    public CompressedElectricIngotFactory(Category category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe, int compressionLevel) {
