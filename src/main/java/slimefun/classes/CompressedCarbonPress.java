...
public class CompressedCarbonPress extends CarbonPress {
	
	private int compression = 1;

    public CompressedCarbonPress(Category category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe, int compressionLevel) {
